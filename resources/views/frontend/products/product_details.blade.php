                ...
                <div class="product-view-inner clearfix">
                    <div class="content-product-left  col-md-5 col-sm-6 col-xs-12">
                        ...
                        <div class="large-image  class-honizol">
                            ...
                            <img class="product-image-zoom" src="{{asset('public/frontend/')}}/image/catalog/demo/product/travel/2.jpg" data-zoom-image="{{asset('public/frontend/')}}/image/catalog/demo/product/travel/2.jpg" title="Canada Travel One or Two European Facials at  Studio" alt="Canada Travel One or Two European Facials at  Studio">
                        </div>
                        <div id="thumb-slider" class="full_slider category-slider-inner products-list yt-content-slider" data-rtl="no" data-autoplay="no" data-pagination="no" data-delay="4" data-speed="0.6" data-margin="10" data-items_column0="3" data-items_column1="3" data-items_column2="3" data-items_column3="3" data-items_column4="2" data-arrows="yes" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
                            ...
                            <div class="owl2-item ">
                                <div class="image-additional">
                                    <a data-index="1" class="img thumbnail " data-image="{{asset('public/frontend/')}}/image/catalog/demo/product/travel/12.jpg" title="Canada Travel One or Two European Facials at  Studio">
                                        <img src="{{asset('public/frontend/')}}/image/catalog/demo/product/travel/12.jpg" title="Canada Travel One or Two European Facials at  Studio" alt="Canada Travel One or Two European Facials at  Studio">
                                    </a>
                                </div>
                            </div>
                            <div class="owl2-item ">
                                <div class="image-additional">
                                    <a data-index="2" class="img thumbnail " data-image="{{asset('public/frontend/')}}/image/catalog/demo/product/travel/13.jpg" title="Canada Travel One or Two European Facials at  Studio">
                                        <img src="{{asset('public/frontend/')}}/image/catalog/demo/product/travel/13.jpg" title="Canada Travel One or Two European Facials at  Studio" alt="Canada Travel One or Two European Facials at  Studio">
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container">
                                                    <a href="#" title="Portable  Compact Charger (External Battery) t45 ">
                                                        <img src="{{asset('public/frontend/')}}/image/catalog/demo/product/electronic/3.jpg " alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45 " class="img-1 img-responsive">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="box-label">
                                    ...
                                    <div class="product-layout">
                                        <div class="product-item-container">
                                            <div class="left-block">
                                                <div class="product-image-container">
                                                    <a href="#" title="Portable  Compact Charger (External Battery) t45 ">
                                                        <img src="{{asset('public/frontend/')}}/image/catalog/demo/product/electronic/6.jpg " alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45 " class="img-1 img-responsive">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="box-label">
                                    ...
                                    <div class="product-layout">
                                        <div class="product-item-container">
                                            <div class="left-block">
                                                <div class="product-image-container">
                                                    <a href="#" title="Portable  Compact Charger (External Battery) t45 ">
                                                        <img src="{{asset('public/frontend/')}}/image/catalog/demo/product/electronic/8.jpg " alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45 " class="img-1 img-responsive">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="box-label">

                    ...
                    <div class="modcontent">
                        <ul>
                                        ...
                                        <div class="so-filter-option" data-type="search">
                                            <div class="so-option-container">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" data-id="{{ $subcate->id }}"
                                                        name="search_field" id="search_field">
                                                    <div class="input-group-btn">
                                                        <button class="btn btn-default" type="button" id="submit_text_search"><i
                            ...
                            <li class="so-filter-options" data-option="Manufacturer">
                                ...
                                <div class="so-filter-content-opts">
                                    <div class="so-filter-content-opts-container">
                                        <div class="so-filter-option opt-select  opt_enable" data-type="manufacturer"
                                            data-manufacturer_value="8" data-count_product="4"
                                            data-list_product="30,58,61,105">
                                            <div class="so-option-container">
                                                <div class="option-input">
                                                    <span class="fa fa-square-o">
                                                    </span>
                                                </div>
                                                <label><img src="{{asset('public/frontend/')}}/image/placeholder.png"
                                        ...
                                        <div class="so-filter-option opt-select  opt_enable" data-type="manufacturer"
                                            data-manufacturer_value="10" data-count_product="1" data-list_product="68">
                                            <div class="so-option-container">
                                                <div class="option-input">
                                                    <span class="fa fa-square-o">
                                                    </span>
                                            ...
                                            <div class="so-filter-options">
                                                <div class="so-filter-option so-filter-price">
                                                    ...
                                                    <div class="content_scroll">
                                                        <div id="slider-range" </div> </div> </div> </div> </div> </div>
                                                            </div> </li> </ul> <div class="clear_filter">
                                                            <a href="javascript:;" class="btn btn-default inverse"
                                                                id="btn_resetAll">
                                                                <span class="hidden fa fa-times"
                                                                    aria-hidden="true"></span> Reset All
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div
                                                    class="moduletable module so-extraslider-ltr best-seller best-seller-custom">
                                                                        ...
                                                                        <div class="item-wrap-inner">
                                                                            <div class="media-left">
                                                                                <div class="item-image">
                                                                                    <div
                                                                                        class="item-img-info product-image-container ">
                                                                                        <div class="box-label">
                                                                                        </div>
                                                                                        <a class="lt-image"
                                                                                            data-product="104" href="#"
                                                                                            target="_self"
                                                                                ...
                                                                                <div class="item-info">
                                                                                    ...
                                                                                    <div class="item-title">
                                                                                        <a href="product.html"
                                                                                            target="_self"
                                                                                            title="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2) ">
                                                                                            Toshiba Pro 21"(21:9) FHD
                                                                                            IPS LED 1920X1080 HDMI(2)
                                                                                        </a>
                                                                                    </div>
                                                                                    <!-- Begin ratting -->
                                                                                    <div class="rating">
                                                                                    ...
                                                                                    <div class="price">
                                                                                        <span
                                                                                            class="old-price product-price">$62.00</span>
                                                                                        <span
                                                                                            class="price-old">$337.99</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <!-- End item-info -->
                    ...
                    <div class="all_category_wise_product">
                        <div class="products-category">
                            ...
                            <div class="products-list grid row number-col-3 so-filter-gird" id="filter">
                                <!-- category product -->
                                @php
                                $products=App\Product::where('is_deleted',0)->where('subcate_id',$subcate->id)->orderBy('id','DESC')->limit(9)->get();
                                @endphp
                                        ...
                                        <div class="right-block">
                                            ...
                                            <div class="button-group">
                                                <a class="quickview iframe-link visible-lg btn-button"
                                                    ...
                                                    href="{{url('product/details/'.$product->id)}}"> <i
                                                ...
                                                <button class="addToCart btn-button" type="button" data-toggle="tooltip"
                                                    ...
                                                    data-original-title="Add to Cart"><span class="hidden">Add to Cart
                                                    </span></button>
                                            </div>
                                        </div>
                                    </div>

		...
		<div class="container">
			<div class="header-bottom-inner">
				<div class="row">
														...
														<ul class="megamenu" data-transition="slide" data-animationtime="300">
															<li class="item-vertical  style1">
																...
																<a href="#" class="clearfix">
																	<span>
																		<strong><i class="icon icon1"></i><img src="{{asset('public/frontend/')}}/image/catalog/demo/menu/icon/icon-6.png" alt="">Hot Deal</strong>
																	</span>
																</a>
															</li>
															<li class="item-vertical  vertical-style2 with-sub-menu hover">
																...
																<a class="clearfix">
																	<span>
																		<strong><i class="icon  icon2"></i><img src="{{asset('public/frontend/')}}/image/catalog/demo/menu/icon/icon-1.png" alt="">Electronics</strong>
																	</span>
															...
															<li class="item-vertical  vertical-style3 with-sub-menu hover">
																...
																<a href="#" class="clearfix">
																	<span>
																		<strong><i class="icon  icon3"></i><img src="{{asset('public/frontend/')}}/image/catalog/demo/menu/icon/icon-2.png" alt="">Travel &amp; Vacation</strong>
																	</span>
																	<b class='fa fa-caret-right'></b>
																</a>
															...
															<li class="item-vertical ">
																...
																<a href="#" class="clearfix">
																	<span>
																		<strong><i class="icon  icon4"></i><img src="{{asset('public/frontend/')}}/image/catalog/demo/menu/icon/icon-3.png" alt="">Book Stationery</strong>
																	</span>
																</a>
															</li>
															<li class="item-vertical   item-style3 with-sub-menu hover">
																...
																<a class="clearfix">
																	<span>
																		<strong><i class="icon  icon5"></i><img src="{{asset('public/frontend/')}}/image/catalog/demo/menu/icon/icon-4.png" alt="">Fashion</strong>
																	</span>
																	<b class='fa fa-caret-right'></b>
																</a>
															...
															<li class="item-vertical ">
																...
																<a class="clearfix">
																	<span>
																		<strong><i class="icon  icon6"></i><img src="{{asset('public/frontend/')}}/image/catalog/demo/menu/icon/icon-5.png" alt="">Sport &amp; Entertaiment</strong>
																	</span>
																</a>
															</li>
															<li class="item-vertical  css-menu with-sub-menu hover">
																...
																<a href="#" class="clearfix">
																	<span>
																		<strong><i class="icon  icon8"></i><img src="{{asset('public/frontend/')}}/image/catalog/demo/menu/icon/icon-8.png" alt="">Spa &amp; Massage</strong>
																	</span>
																	<b class='fa fa-caret-right'></b>
																</a>
															...
															<li class="item-vertical ">
																...
																<a href="#" class="clearfix">
																	<span>
																		<strong><i class="icon  icon9"></i><img src="{{asset('public/frontend/')}}/image/catalog/demo/menu/icon/icon-9.png" alt="">Real House</strong>
																	</span>
																</a>
															</li>
															<li class="item-vertical ">
					...
					<!-- include main menu for home page two -->
					
					@include('frontend.include.mainmenu.home2')
				</div>
			</div>
		</div>
	</div>
                                        ...
                                        <ul class="megamenu" data-transition="slide" data-animationtime="300">
                                            <li>
                                                ...
                                                <a class="clearfix">
                                                    <span>
                                                        <strong>
                                                            <img src="{{asset('public/frontend')}}/image/catalog/demo/menu/icon/icon-6.png"
                                            ...
                                            <li class="item-vertical  vertical-style2 with-sub-menu hover">
                                                ...
                                                <a class="clearfix">
                                                    <span>
                                                        <strong>
                                                            <img src="{{asset('public/uploads/category/'.$menu->cate_icon)}}" alt="">{{$menu->cate_name}}
                                                        </strong>
                                                    </span>
                                                                ...
                                                                <div class="html item-1">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="img-banner col-lg-5 col-md-5 col-sm-4">
                                                                            <a href="#">
                                                                                <img src="{{asset('public/frontend/')}}/image/catalog/demo/menu/img-static-megamenu-h.jpg" alt="banner"></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>

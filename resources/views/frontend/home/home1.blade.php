                                            ...
                                            <div class="transition product-layout">
                                                <div class="product-item-container ">
                                                    ...
                                                    <div class="right-block">
                                                        <div class="caption">
                                                            <h4><a href="{{ route('product.details',$flasdetail->product->id) }}"
                                                                    target="_self"
                        ...
                        <div>
                            <div class="home1-banner-2 clearfix">
                                <div class="item-1 col-lg-6 col-md-6 col-sm-6 banners">
                                    <div>
                                        <a title="Static Image" href="#"><img src="{{asset('public/')}}/1555.png"
                                                alt="Static Image"></a>
                                    </div>
                                </div>
                                                                ...
                                                                <div class="right-block">
                                                                    <div class="caption">
                                                                        ...
                                                                        <div class="total-price clearfix">
                                                                            ...
                                                                            <div class="price-sale price-right"><span
                                                ...
                                                <div class="ltabs-items ltabs-items-selected items-category-4"
                                                    ...
                                                    <div class="ltabs-items-inner ltabs-slider ">
                                                        ...
                                                        <div class="ltabs-item">
                                                            ...
                                                            @endphp
                                                            @foreach($products
                                                            as $product) <div class="item-inner
                                                            product-layout
                                                            transition
                                                            product-grid">
                                                                <div class="product-item-container">
                                                    ...
                                                    <div class="ltabs-items-inner ltabs-slider">
                                                        ...
                                                        <div class="ltabs-item
                                                            ...
                                                            @endphp @foreach($pro as $product) <div class="item-inner product-layout
                                                                ...
                                                                <div class="product-item-container">
                                                                    <div class="left-block">
                                                                        <div class="image product-image-container "> <a
                                                                                class="lt-image" href="#" target="_self"

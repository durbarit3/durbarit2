			 ...
			 <div class="form-group row">
			    ...
			    <div class="col-sm-8">
			      <select class="form-control" name="section">
			      		<option value="1">Ban(435*175)</option>
			      		<option value="2">Ban(570*300)</option>
						<option value="3">Ban(270*854)</option>
						<option value="4">Ban(270*427)</option>
						<option value="5">Ban(362*495)</option>	
						<option value="6">Ban(1920*180)</option>	
			      </select>
			    </div>
			  </div>

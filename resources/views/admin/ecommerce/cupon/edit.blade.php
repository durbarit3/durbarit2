...
<option value="{{$product->id}}"  @if( in_array($product->id ,json_decode($data->product_id))) selected @else @endif > {{$product->product_name}}</option>
								...
								<div class="form-group row">
								    ...
								    <div class="col-sm-3">
								      <input type="date" class="form-control" name="cupon_start_date" placeholder="Start Date" value="{{$data->cupon_start_date}}">
								    </div>
								    <div class="col-sm-3">
								      <input type="date" class="form-control" name="cupon_end_date" placeholder="End Date" value="{{$data->cupon_end_date}}">
								    </div>
								</div>

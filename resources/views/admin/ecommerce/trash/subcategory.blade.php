				...
				<div class="middle_content_wrapper">
					<section class="page_content">
						...
						<div class="panel mb-0">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="panel_title">
											<span class="panel_icon"><i class="fas fa-border-all"></i></span><span>All Deleted SubCategory</span>
										</div>
									</div>
							...
							<form action="{{url('admin/trash/subcategory/multipledelete')}}" method="post">
						     @csrf
				             ...
				             <button type="button"  style="margin: 5px;" class="btn btn-info" ><i class="fas fa-undo"></i> <a href="{{route('admin.subcategory.all')}}" style="color: #fff;">Back</a></button>
		                              ...
		                              <tbody>
		                                  ...
		                                  <tr>
		                                      ...
		                                      <td>{{$data->subcate_tag}}</td>
		                                       <td>
		                                           	<a class="btn btn-sm btn-blue text-white" href="{{url('admin/subcategory/restore/'.$data->id)}}"><i class="fas fa-recycle"></i></a> |
          ...
          <form class="form-horizontal" action="{{route('admin.subcategory.insert')}}" method="POST" enctype="multipart/form-data" >
			 ...
			 <div class="form-group row">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-8">
			      <input type="text" name="subcate_tag" class="form-control" required>
			    </div>
			  </div>

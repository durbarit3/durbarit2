				...
				<div class="middle_content_wrapper">
					<section class="page_content">
						...
						<div class="panel mb-0">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="panel_title">
											<span class="panel_icon"><i class="fas fa-border-all"></i></span><span>All Deleted Color</span>
										</div>
									</div>
							...
							<form action="{{route('admin.trash.color.delete')}}" method="post">
						     @csrf
							<button type="submit" style="margin: 5px;" name="submit" class="btn btn-danger" value="delete" ><i class="fa fa-trash"></i> Delete All</button>
				             ...
				             <button type="button"  style="margin: 5px;" class="btn btn-info" ><i class="fas fa-undo"></i> <a href="{{route('admin.color.all')}}" style="color: #fff;">Back</a></button>
		                              ...
		                              <tbody>
		                                  ...
		                                  <tr>
		                                      ...
		                                      <td>
		                                       ...
		                                       <td>
		                                           	<a href="{{url('admin/color/recover/'.$data->id)}}" class="btn btn-info btn-sm text-white" data-toggle="tooltip" data-placement="right" title="active" data-original-title="active"><i class="fas fa-recycle"></i></a> | 
		                                            <a id="delete" href="{{url('admin/color/delete/'.$data->id)}}" class="btn btn-danger btn-sm text-white" data-toggle="tooltip" data-placement="right" title="Delete" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>
		                                       </td>
		                                  </tr>
		                             	@endforeach
		                              </tbody>
